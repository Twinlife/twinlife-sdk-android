...
public class BlueprintConfiguration extends TwinlifeConfiguration {
	...
	BlueprintConfiguration(TwinlifeApplicationImpl twinlifeApplication) {
		...
		peerConnectionServiceConfiguration.incomingCallHandler = InboundActivity.class;
		peerConnectionServiceConfiguration.maxPeerConnections = 1;

		// TwincodeInboundService Configuration
		baseServiceConfigurations[BaseServiceId.TWINCODE_INBOUND_SERVICE_ID
